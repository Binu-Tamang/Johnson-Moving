            ...
            <div class="row">
                <div class="col-12 col-sm-6 col-md-6 width-wrap">
                    <div class="quote-h-content wow slideInLeft">
                        <h2 class="web-header text-start" data-wow-duration="1s">Get A Free Quote</h2>
...
<section class="testimonial-plan">
    ...
    <div class="review-wrap bg-wrap-b">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                        ...
                        <div class="owl-carousel owl-theme testimonial-owl">
                            <div class="item">
                                <div class="testimonial-boxes">
                                    ...
                                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nemo consequatur
                                        voluptatem mollitia iure libero explicabo quasi ullam, delectus eos
                                        quibusdam
                                    </p>
                                </div>
                            </div>
            ...
            <div class="col-md-8">
                ...
                <div class="parent-container faqs-box">
                    ...
                    <div class="faqs-box-wrap">
                        <ul class="faq">
                            <li class="active">
                                <span class="question">How do you protect my things when moving?
                            ...
                            <li>
                                <span class="question"> Is this a full service professional movers company?
