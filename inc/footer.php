    ...
    <div class="container">
        ...
        <div class="footer-up">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="footer-box">
                        <h5 class="footer-h">Social Network</h5>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="footer-down-copyr text-center">
                        <p>Copyright © 2024, <span>Johnson Moving & Storage.</span>, all rights reserved </p>
                    </div>
                    <div class="footer-down-policy text-center">
                        <p>Designed & Hosted By : <a href="#"><img src="assets/img/maple.jpg" alt="maple logo"></a></p>
                    </div>
                </div>
